    ...
    <>
      ...
      <div id="root">
        <div className="small-device">
          <p className="text">
            <span>Small device detected!</span>
            <br />
            <br />A device smaller than 768px has been detected
          </p>
        </div>
              ...
              <div className="modal-body-inner">
                <div className="body-icon">
                  {isDraw == true && (
                    ...
                    >
                      <path
                        d="M5.75 12.25L14.25 3.75V1.75H12.25L3.75 10.25M2.75 9.25L4.25 11.75L6.25 13.25L2.75 9.25ZM1.75 13.25L2.75 14.25L1.75 13.25ZM4.25 11.75L2.75 13.25L4.25 11.75Z"
                        stroke="#181616"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M6 8L1.75 3.75V1.75H3.75L8 6M10.25 12.25L8 10L10.25 12.25ZM10 8L12.25 10.25L10 8ZM13.25 9.25L11.75 11.75L9.75 13.25L13.25 9.25ZM14.25 13.25L13.25 14.25L14.25 13.25ZM11.75 11.75L13.25 13.25L11.75 11.75Z"
                        stroke="#181616"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <div className="modal-restart">
                  <button
                    type="button"
                    className="restart"
                    onClick={(e) => restartGameRefresh(e)}
                  >
                    Restart
                  </button>
                </div>
        ...
        <div
          className={
            markdownWindow == true ? "markdown-modal is-open" : "markdown-modal"
          }
        >
          <div className="markdown-modal-inner">
            <div className="markdown-modal-header">
              ...
              <div
                ...
                onClick={(e) => setMarkdownWindow(false)}
              >
                <svg
                  width="20"
                  height="20"
